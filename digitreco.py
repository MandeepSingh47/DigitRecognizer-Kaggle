...
data_generator = ImageDataGenerator(rescale=0, rotation_range=10, zoom_range=0.1, width_shift_range=0.1,
...
learning_rate_reduction = ReduceLROnPlateau(monitor='val_accuracy', factor=0.5, verbose=1, patience=3, min_lr=0.0001)
epochs = 30
batch_size = 86
